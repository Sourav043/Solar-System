...
#include "Uranus_Orbit.h"
#include "ProceduralMeshComponent.h"
#include "Engine.h"


AUranus_Orbit::AUranus_Orbit()
{
...
void AUranus_Orbit::BeginPlay()
{
	Super::BeginPlay();
	GenerateHollowEllipseMesh();
}

void AUranus_Orbit::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 9100.0f;
	const float OuterRadiusY = 8800.0f;
