#include "Neptune_Orbit.h"
#include "ProceduralMeshComponent.h"
#include "Engine.h"

ANeptune_Orbit::ANeptune_Orbit()
{
...
void ANeptune_Orbit::BeginPlay()
{
	Super::BeginPlay();
	GenerateHollowEllipseMesh();
}

void ANeptune_Orbit::GenerateHollowEllipseMesh()
{
	...
	const float OuterRadiusX = 10100.0f;
	const float OuterRadiusY = 9800.0f;
